...
player_pose2d_t readPosition(LocalizeProxy& lp, double& highestWeight);
void printLaserData(LaserProxy& sp);
void printRobotData(BumperProxy& bp, player_pose2d_t pose, double highestWeight);
...
{  
  ...
  while(true) 
    {    
      ...
      pose = readPosition(lp,highestWeight);
	...
	printLaserData(sp);
      ...
      printRobotData(bp, pose, highestWeight);
...
void printRobotData(BumperProxy& bp, player_pose2d_t pose, double highestWeight)
{
  ...
  std::cout << "I am at:" << std::endl;
  std::cout << "X: " << pose.px << std::endl;
  std::cout << "Y: " << pose.py << std::endl;
  std::cout << "A: " << pose.pa << std::endl;
  std::cout << "I am " << highestWeight*100 << " percent sure of my position" << std::endl; 
